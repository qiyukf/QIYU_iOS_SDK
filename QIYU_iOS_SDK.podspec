Pod::Spec.new do |s|
    ...
    s.source   = { :git => 'https://github.com/qiyukf/QIYU_iOS_SDK.git', :tag => "4.4.0" }
    s.platform = :ios
    ...
    s.framework = 'UIKit','CoreText','MobileCoreServices','SystemConfiguration','AVFoundation','CoreTelephony','CoreMedia','AudioToolbox','AssetsLibrary','ImageIO'
